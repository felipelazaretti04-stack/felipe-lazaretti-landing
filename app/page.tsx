        ...
        >
          ...
          <Container className="py-20 sm:py-24">
            <div className="mx-auto max-w-3xl text-center">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm text-white/80 shadow-soft">
              ...
              <div className="mt-10 grid grid-cols-1 gap-3 sm:grid-cols-3">
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-left shadow-soft">
                  <div className="flex items-center gap-2 text-white">
                    <Icon name="spark" className="h-5 w-5 text-blue-300" />
                    <span className="font-medium">Visual premium</span>
                  </div>
                  <p className="mt-2 text-sm text-white/70">
                    Layout moderno, tipografia forte e detalhes que passam
                    confiança.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-left shadow-soft">
                  <div className="flex items-center gap-2 text-white">
                    ...
                    <span className="font-medium">Entrega organizada (15 dias)</span>
                  </div>
                  <p className="mt-2 text-sm text-white/70">
                    Processo claro do briefing até a publicação, com alinhamentos
                    rápidos.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-left shadow-soft">
                  <div className="flex items-center gap-2 text-white">
                    ...
                    <span className="font-medium">Site leve e pronto pra crescer</span>
                  </div>
                  <p className="mt-2 text-sm text-white/70">
                    Performance, SEO básico e estrutura preparada para evoluir.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="border-t border-white/10 py-10">
        <Container className="flex flex-col items-center justify-between gap-3 sm:flex-row">
          <p className="text-sm text-white/60">
            © {new Date().getFullYear()} Felipe Lazaretti. Todos os direitos reservados.
          </p>
...
function ServiceCard({
  ...
  return (
    <div className="group rounded-2xl border border-white/10 bg-white/5 p-5 shadow-soft transition hover:border-white/15 hover:bg-white/7">
      <div className="flex items-center gap-2 text-white">
...
function PlanCard({
  ...
  return (
    <div
      className={[
        "relative rounded-2xl border bg-white/5 p-6 shadow-soft",
        highlight ? "border-white/20 shadow-glow" : "border-white/10"
      ].join(" ")}
    >
      {highlight && (
