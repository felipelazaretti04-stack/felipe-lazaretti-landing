        ...
        >
          ...
          <Container className="py-20 sm:py-24">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1
                className="animate-fadeUp mt-6 text-balance text-4xl font-semibold tracking-tight text-white sm:text-6xl motion-reduce:animate-none"
              ...
              <p
                className="animate-fadeUp mt-5 text-pretty text-base leading-relaxed text-white/75 sm:text-lg motion-reduce:animate-none"
              ...
              <div
                className="animate-fadeUp mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row motion-reduce:animate-none"
              ...
              >
                ...
                <div className="group rounded-2xl border border-white/10 bg-black/40 sm:bg-black/40 sm:bg-black/40 sm:bg-white/5 backdrop-blur backdrop-blur backdrop-blur p-4 text-left shadow-soft transition will-change-transform hover:-translate-y-1 hover:border-white/15 hover:bg-white/7 hover:shadow-glow motion-reduce:transform-none">
                  <div className="flex items-center gap-2 text-white">
                    ...
                    <span className="font-medium">
                      Site leve e pronto pra crescer
                    </span>
                  </div>
                  <p className="mt-2 text-sm text-white/70">
